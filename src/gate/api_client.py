...
class TowerClient:
    ...
    def start_recording(self, session_id: str, person_username: str,
        ...
        response = self._request('POST', '/api/v1/recordings/start', json=payload)
        return response
    ...
    def upload_recording_chunk(self, session_id: str, recording_path: str,
        ...
        response = self._request('POST', '/api/v1/recordings/chunk', json=payload)
        return response
    ...
    def finalize_recording(self, session_id: str, recording_path: str,
        ...
        response = self._request('POST', '/api/v1/recordings/finalize', json=payload)
        return response
